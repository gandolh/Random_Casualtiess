...
case 2:{
	document.getElementById('iframeAnimation').src='../../javascript/p5js/Others/futuristic animation/index.html'
	break;
}

case 3:{
	document.getElementById('iframeAnimation').src='../../javascript/p5js/Others/genetic algorithm - original/index.html'
	break;
}
...
case 7:{
	document.getElementById('iframeAnimation').src='../../javascript/p5js/Others/purpleRain/index.html'
	break;
}
...
case 11:{
	document.getElementById('iframeAnimation').src='../../javascript/p5js/Others/retro art/index.html'
	break;
}
